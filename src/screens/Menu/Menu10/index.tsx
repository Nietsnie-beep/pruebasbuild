    ...
    <Container style={styles.container}>
      <TopNavigation
        accessoryRight={() => {
          return (
            <Button
              accessoryLeft={() => <Icon pack="assets" name="arrow_right" />}
              status="primary"
        ...
        // @ts-ignore
        accessoryLeft={<Image source={Images.logo} style={styles.logo} />}
      />
      <FlatList
        data={DATA}
          ...
          return (
            <TouchableOpacity
              ...
              <View style={styles.titleView}>
                <Text
                  uppercase
                  status={!isActive ? 'platinum' : 'primary'}
      ...
      {/* @ts-ignore */}
      <Image source={Images.reading.reading_home} style={styles.book} />
    </Container>
  );
});
